                ...
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"><img style="max-height: 420px !important;"
                                                                   class="d-block w-100" src="{{$product->thumb}}"
                            ...
                            @if ($product->price !== NULL)
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="form-group quantity-box">
                                            ...
                                            <input class="form-control" name="num_product" value="1" min="0" max="20"
                                                   type="number">
                                        </div>
                                    </li>
                                </ul>
                                ...
                                <div class="price-box-bar">
                                    <div class="cart-and-bay-btn">
                                        <input class="btn hvr-hover" type="submit" value="Thêm vào giỏ hàng">
                                    </div>
                                </div>
                            @endif
                            @csrf
                                ...
                                <div class="products-single fix">
                                    <div class="box-img-hover">
                                        <img src="{{$item->thumb}}" class="img-fluid"
                                             style="max-height: 367px !important;" alt="{{$item->name}}">
                                        <div class="mask-icon">
                                            <ul>
                                                <li><a class="nav-link"
                                                       href="/san-pham/{{$item->id}}-{{Str::slug($item->name,'-')}}.html"

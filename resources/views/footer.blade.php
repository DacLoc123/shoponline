            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="footer-link">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Chính sách bảo mậty</a></li>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="footer-link-contact">
                        ...
                        <ul>
                            <li>
                                <p><i class="fas fa-map-marker-alt"></i>Địa chỉ: số 1 Cầu Giấy
                                    , Hà Nội </p>
                            </li>
                            <li>
...
<div class="footer-copyright">
    <p class="footer-company">All Rights Reserved. &copy; 2021 <a href="#">{{$title}}</a> Design By :
        <a href="https://html.design/">Nhóm 18</a></p>
</div>
<!-- End copyright  -->
